...
public class LoggerTest {
    ...
    public void testCommonLoggerForAllLevels() throws Exception {
        ...
        SessionValue sessionValue = LoggerSession.start(
                ...
                null,
                10,
                "NO_VIDEO", false, false, false, 30, "FAST"
        );
    ...
    public void testMultipleLoggerInstances() throws Exception {
        ...
        SessionValue session1 = LoggerSession.start(COMMON_FILE_ALL_LEVEL, instance1Path, null, null, null, 10, "NO_VIDEO", false, false, false, 30, "FAST");
        SessionValue session2 = LoggerSession.start(COMMON_FILE_ALL_LEVEL, instance2Path, null, null, null, 10, "NO_VIDEO", false, false, false, 30, "FAST");
    ...
    public void testLogMessageWithoutScreenshot() throws Exception {
        ...
        SessionValue sessionValue = LoggerSession.start(COMMON_FILE_ALL_LEVEL, commonLogPath, null, null, null, 10, "NO_VIDEO", false, false, false, 30, "FAST");
    ...
    public void testLogFileSize() throws Exception {
        ...
        SessionValue sessionValue = LoggerSession.start(COMMON_FILE_ALL_LEVEL,
                baseTestPath + "size_test.html", null, null, null, 10, "NO_VIDEO", false, false, false, 30, "FAST");
